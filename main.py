...
from config import DEB_HASH, DEB_PACKAGE_URL, DEQUE_SIZE, DOWNLOAD_FAILED, INCORRECT_HASH, NPM_HASH, NPM_PACKAGE_URL, PYPI_HASH, PYPI_PACKAGE_URL, REQUEST_EVERY, SLA, SUCCESS
